      ...
      <table class="w3-table w3-striped">
        <form class="" action="edit.php" method="post">
          <tr>
            <td><h3>Nama</h3></td>
            <td><h3>:</h3></td>
            <td><input class="w3-input w3-animate-input" type="text" style="width:50%" name="nama" placeholder="<?php  $d=$ok->profile($temp,'nama'); echo $d; ?>"></td>
          </tr>
          <tr>
            <td><h3>Marga</h3></td>
            <td><h3>:</h3></td>
            <td><input class="w3-input w3-animate-input" type="text" style="width:50%" name="marga" placeholder="<?php  $d=$ok->marga($temp,'marga'); echo $d; ?>"></td>
          </tr>
          <tr>
            <td><h3>Beibe</h3></td>
            <td><h3>:</h3></td>
            <td><input class="w3-input w3-animate-input" type="text" style="width:50%" name="marga" placeholder="<?php  $d=$ok->marga($temp,'mamak'); echo $d; ?>"></td>
          </tr>
          <tr>
            <td><h3>Jenis Kelamin</h3></td>
            <td><h3>:</h3></td>
            <td><input class="w3-input w3-animate-input" type="text" style="width:50%" name="marga" placeholder="<?php  $d=$ok->jk($temp,'Jenis_kelamin'); echo $d; ?>"></td>
          </tr>
          <tr>
            <td><h3>Prodi</h3></td>
            <td><h3>:</h3></td>
            <td><input class="w3-input w3-animate-input" type="text" style="width:50%" name="marga" placeholder="<?php  $d=$ok->profile($temp,'prodi'); echo $d; ?>"></td>
          </tr>
          <tr>
            <td><h3>Angkatan</h3></td>
            <td><h3>:</h3></td>
            <td><input class="w3-input w3-animate-input" type="text" style="width:50%" name="marga" placeholder="<?php  $d=$ok->profile($temp,'angkatan'); echo $d; ?>"></td>
          </tr>
          <tr>
            <td></td>
            <td><input type='hidden' name='id' value=<?php $temp ?>></td>
